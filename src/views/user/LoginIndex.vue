  ...
  <div class="login-app">
    ...
    <el-card class="box-card">
      ...
      <div style="display: flex">
        <el-checkbox class="rem-text" v-model="remembered"
          >我已同意《服务条款》</el-checkbox
        >
        <router-link to="/register">
          <el-link class="logon-text" :underline="false">注册</el-link>
        </router-link>
      </div>
    ...
    const login = () => {
      ...
      userLogin(user).then((data) => {
        ...
        if (data.code === 200) {
          ...
          store.commit("user/setUser", { userID, username, token });
          // 跳转
